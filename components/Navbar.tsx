    ...
    <nav className="bg-cream shadow-md">
      ...
      <div className={`md:hidden ${isMenuOpen ? "block" : "hidden"}`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <button className="w-full text-left bg-wood-medium hover:bg-wood-dark text-cream font-bold py-2 px-4 rounded transition-colors duration-300 mt-2 text-sm">
            Sign In
          </button>
        </div>
      </div>
